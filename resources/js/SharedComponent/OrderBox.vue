...
<template>
    <Drawer v-model:open="isOpen">
        ...
        <DrawerContent>
            <DrawerHeader>
                <DrawerTitle class="mb-5 text-center text-primary">Order</DrawerTitle>
                <DrawerDescription>
                    <ScrollArea class="h-[700px] max-w-[500px] mx-auto p-4">
                        <div class="grid gap-4">
                            <div class="bg-accent grid border rounded-lg overflow-hidden mb-4 md-custom:grid-cols-2 gap-2 relative max-w-[500px]">
                                <div class="p-4">
                                    <h3 class="mb-2 text-base font-semibold text-primary">Meal Name</h3>
                                    <p class="max-w-sm text-gray-600 break-words text-tiny">{{ menuName }}</p>
                                </div>
                                <div class="p-3 my-auto overflow-hidden rounded-lg">
                                    <img src="../../assets/pic1.jpg" alt="Image" class="object-cover w-full h-32 rounded-lg md-custom:w-42 md-custom:h-40"/>
                                </div>
                            </div>
                            <div class="flex flex-col gap-2 mb-[150px]">
                                <p class="mb-5 text-primary">Customer Personal Information</p>
