...
<template>
    <Drawer v-model:open="isOpen">
        <DrawerTrigger class="p-4 text-left border rounded-lg bg-accent hover:text-primary">
                    ...
                    <ScrollArea class="h-[700px] max-w-[500px] mx-auto p-4">
                        <div class="grid gap-4">
                            <div
                                ...
                                <div class="p-4">
                                    <h3 class="mb-2 text-base font-semibold text-primary">
                                        Meal Name
                                    </h3>
                                    <p class="max-w-sm text-gray-600 break-words text-tiny">
                                        {{ menuName }}
                                    </p>
                                </div>
            ...
            <DrawerFooter>
                ...
                <DrawerClose>
                    ...
                    <form @submit.prevent="handleCancelOrder" class="w-full">
                        <Button type="submit"
                            class="bg-accent border border-primary text-primary hover:bg-secondary hover:text-accent hover:border-none w-full">
                            Reject Order
                        </Button>
                    </form>
                </DrawerClose>
