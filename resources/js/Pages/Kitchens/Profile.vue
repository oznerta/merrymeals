...
const updateUser = () => {
    ...
    updateForm.put("/kitchen/profile");
};
...
const updateEmail = () => {
    // Send form data to the backend using Inertia
    updateEmailForm.put("/kitchen/profile");
};
...
const updatePassword = () => {
    // Send form data to the backend using Inertia
    updatePasswordForm.put("/kitchen/profile");
};
</script>
...
<template>
    ...
    >
        <div class="mb-10">
            <h2 class="mb-5 font-semibold text-secondary">My Kitchen</h2>

            <form @submit.prevent="updateUser" class="flex flex-col gap-3">
                <Input
                    type="text"
                    v-model="updateForm.restaurant_name"
